...
manager.on("giveawayReactionAdded", async (giveaway, member, reaction) => {
  ...
  passport.use(new Strategy({
	clientID: "1148272812709118073",
	clientSecret: "zMIIeS0-C3aKKx-X9HWR7EMcE8uS-QH3",
	callbackURL: 'https://RikoBot.repl.co/auth',
  ...
  app.use(session({
    ...
    secret: "zMIIeS0-C3aKKx-X9HWR7EMcE8uS-QH3",
    resave: false,
...
app.locals.domain = 'https://RikoBot.repl.co/';
...
app.get("/invite", (req,res) => {
  res.redirect(`https://discord.com/api/oauth2/authorize?client_id=1151631501016969307&permissions=8&scope=bot`)
})
